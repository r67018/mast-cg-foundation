...
# パターン1: 一様Bスプライン（等間隔）- 標準的な近似曲線
# g_NotVector = list(range(0, 12))

# パターン2: 開いた一様Bスプライン - 始点・終点が制御点を通る（推奨）
g_NotVector = [0, 0, 0, 0, 1, 2, 3, 4, 4, 4, 4]

# パターン3: ベジェ曲線と同等（すべてのノットが0または1）
# g_NotVector = [0, 0, 0, 0, 1, 1, 1, 1]

# パターン4: 非一様（特定部分の制御を強化）
# g_NotVector = [0, 0, 0, 0, 1, 1, 2, 3, 3, 3, 3]

# パターン5: 重複ノットあり（曲線が折れる）
# g_NotVector = [0, 0, 0, 0, 1, 2, 2, 3, 3, 3, 3]
